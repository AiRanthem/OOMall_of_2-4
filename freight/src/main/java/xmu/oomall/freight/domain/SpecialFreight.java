...
public class SpecialFreight {
    ...
    public SpecialFreight(Integer id, Integer firstNumPiece, BigDecimal firstNumPiecePrice, Integer continueNumPiece, BigDecimal continueNumPiecePrice, LocalDateTime gmtCreate, LocalDateTime gmtModified, Boolean beDeleted) {
        this.id = id;
    ...
    public SpecialFreight(SpecialFreightPo specialFreightPo) {
        this.id = specialFreightPo.getId();
        this.firstNumPiece = specialFreightPo.getFirstNumPiece();
        this.firstNumPiecePrice = specialFreightPo.getFirstNumPiecePrice();
        this.continueNumPiece = specialFreightPo.getContinueNumPiece();
        this.continueNumPiecePrice = specialFreightPo.getContinueNumPiecePrice();
        this.gmtCreate = null;
