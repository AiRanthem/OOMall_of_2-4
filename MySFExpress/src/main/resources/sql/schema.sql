...
-- ----------------------------
-- Table structure for addressPo
-- ----------------------------
DROP TABLE IF EXISTS `addressPo`;
CREATE TABLE `addressPo` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
  `gmt_create` datetime(2) DEFAULT NULL,
  `gmt_modified` datetime(2) DEFAULT NULL,
  `is_deleted` tinyint(1) unsigned DEFAULT '0',
...
-- ----------------------------
-- Table structure for commentPo
-- ----------------------------
DROP TABLE IF EXISTS `commentPo`;
CREATE TABLE `commentPo` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(11) unsigned DEFAULT NULL,
  `content` varchar(255) DEFAULT NULL,
  `status` tinyint(2) DEFAULT NULL,
...
CREATE TABLE `order` (
  ...
  `addressPo` varchar(255) DEFAULT NULL,
  `gmt_create` datetime(2) DEFAULT NULL,
  `gmt_modified` datetime(2) DEFAULT NULL,
  `is_deleted` tinyint(1) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
