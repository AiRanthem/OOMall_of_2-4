...
public class Admin {
    ...
    public Admin(Integer id, String username, String password, Integer roleId, LocalDateTime gmtCreate, LocalDateTime gmtModified, Boolean beDeleted) {
        this.id = id;
