...
public class DefaultFreight {
    ...
    public DefaultFreight(Integer id, String destination, BigDecimal firstHeavyPrice, BigDecimal continueHeavyPrice, BigDecimal over10Price, BigDecimal over50Price, BigDecimal over100Price, BigDecimal over300Price, String requireDays, LocalDateTime gmtCreate, LocalDateTime gmtModified, Boolean beDeleted) {
        this.id = id;
    ...
    public DefaultFreight(DefaultFreightPo defaultFreightPo) {
        this.id = defaultFreightPo.getId();
        this.destination = defaultFreightPo.getDestination();
        this.firstHeavyPrice = defaultFreightPo.getFirstHeavyPrice();
        this.continueHeavyPrice = defaultFreightPo.getContinueHeavyPrice();
        this.over10Price = defaultFreightPo.getOver10Price();
        this.over50Price = defaultFreightPo.getOver50Price();
        this.over100Price = defaultFreightPo.getOver100Price();
        this.over300Price = defaultFreightPo.getOver300Price();
        this.requireDays = defaultFreightPo.getRequireDays();
        this.gmtCreate = null;
        this.gmtModified = null;
        this.beDeleted = false;
    }

    public DefaultFreight(Integer id, String destination, BigDecimal firstHeavyPrice, BigDecimal continueHeavyPrice, BigDecimal over10Price, BigDecimal over50Price, BigDecimal over100Price, BigDecimal over300Price, String requireTime) {
        this.id = id;
        this.destination = destination;
        this.firstHeavyPrice = firstHeavyPrice;
        this.continueHeavyPrice = continueHeavyPrice;
